// le mot-clé "export" permet de partager des données d'un fichier à un autre fichier
// type="module" présent dans le fichier html nous permet d'utiliser le mot-clé export
